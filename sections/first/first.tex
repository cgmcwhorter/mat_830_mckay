...
% Tetrahedron
        ...
        \draw[fill=pur,opacity=0.6] (V1) -- (V2) -- (V3); %r
        \draw[fill=cof,opacity=0.6] (V2) -- (V3) -- (V4); %l
...
%\[
%\begin{tikzpicture}[thick]
%\coordinate (V1) at (-0.862045,1.62766,0.474995);
%
%\coordinate (V2) at (-0.178005,1.30131,-1.37584);
%
%\coordinate (V3) at (0.178005,-1.30131,1.37584);
%
%\coordinate (V4) at (0.862045,-1.62766,-0.474995);
%
%\coordinate (V5) at (0.329623,0.656657,1.75447);
%
%\coordinate (V6) at (1.43642,0.12861,-1.24023);
%
%\coordinate (V7) at (-1.43642,-0.12861,1.24023);
%
%\coordinate (V8) at (-0.329623,-0.656657,-1.75447);
%
%\coordinate (V9) at (1.10736,1.5404,0.137651);
%
%\coordinate (V10) at (1.75015,-0.269811,0.694404);
%
%\coordinate (V11) at (-1.75015,0.269811,-0.694404);
%
%\coordinate (V12) at (-1.10736,-1.5404,-0.137651);
%
%
%%\draw (V1) -- (V11) -- (V7) -- (V1);
%%\draw (V1) -- (V9) -- (V5) -- (V1);
...
If this were $2\pi$, the solid would be flat, i.e. a tiling of the plane. If the angle were $>2\pi$, the angle would be concave if and only if $\dfrac{2}{p} + \dfrac{2}{q}>1$. The integer solutions are $\{p,2\}$, $\{2,q\}$ or $\{3,3\}$, $\{3,4\}$, or $\{3,5\}$. We can also use Euler's Formula $V-E+F=1$ to work out $V,E, F$. 
	...
	\end{tabular}
	\end{table} \\
% add column with picture
% tetra self dual
% Otherwise dual pairs draw arrows between rows
\qed \\
...
Furthermore, these will all be familiar groups. % for tetrahedron $A_4$, c.f. Dummit Foote exercise.
